...
hanshu.pj=[];
hanshu.dd=[];
TTHHO_huatu= repmat(hanshu, 30, 1);
%%%%%%%%%%%%%%%%%%%%%%测试
if c==1 
...
%% % %              FF=duoyu(i);
    ...
    for j1=1:run
        ...
        [bestfit,Bestcost1,Bestcost2,pop,t]=TTHHO(fobj,fhd,lb,ub,dim,search_agent,FF);
...
%         biaoji(j1).zong=zongjie;
        ...
        diedaihui_TTHHO(i1,:)=Bestcost1;
    end
    TTHHO_huatu(i1).pj=hanshupj;
    TTHHO_huatu(i1).dd=hanshudd;
...
save('TTHHOO_huatu.mat','diedaihui_TTHHO')
