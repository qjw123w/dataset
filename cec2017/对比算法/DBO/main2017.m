...
%% % %              FF=duoyu(i);
    ...
    for j1=1:run
        ...
        [bestfit,Bestcost1,Bestcost2,pop,t]=wanshang2(fobj,fhd,lb,ub,dim,search_agent,FF);
...
%         biaoji(j1).zong=zongjie;
        ...
        diedaihui_MDBO(i1,:)=Bestcost1;
        
    end
    huatu(i1).pj=hanshupj;
    
    huatu(i1).dd=hanshudd;
