...
%% % %              FF=duoyu(i);
    ...
    for j1=1:run
        ...
        [lb,ub,dim]=Get_Functions_detailsCEC(ceshihanshu(i1));
        ...
        [bestfit,Bestcost1,Bestcost2,pop,t]=MTVSCA2017(fobj,fhd,lb,ub,dim,search_agent,FF);
...
%         biaoji(j1).zong=zongjie;
        ...
        diedaihui_MTVSCA(i1,:)=Bestcost1;
    end
    SCA_huatu(i1).pj=hanshupj;
    SCA_huatu(i1).dd=hanshudd;
...
%     t_b=t_b+1;
    ...
    jk=ceshihanshu(i1);
%     fprintf('function %d mean%d,±ê×¼²î%d\n',jk,fit_ave(i1),fit_std(i1));
...
save('SCA_huatu.mat','diedaihui_MTVSCA')
