...
%% % %              FF=duoyu(i);
    ...
    for j1=1:run
        ...
        [bestfit,Bestcost1,Bestcost2,pop,t]=ALA(fobj,fhd,lb,ub,dim,search_agent,FF);
...
%         biaoji(j1).zong=zongjie;
        ...
        diedaihui_ALA(i1,:)=Bestcost1;
    end
    ALA_huatu(i1).pj=hanshupj;
    ALA_huatu(i1).dd=hanshudd;
