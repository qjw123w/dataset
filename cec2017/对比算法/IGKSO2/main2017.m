...
hanshu.pj=[];
hanshu.dd=[];
IGKSO2_huatu= repmat(hanshu, 30, 1);
%%%%%%%%%%%%%%%%%%%%%%测试
if c==1 
...
%% % %              FF=duoyu(i);
    ...
    for j1=1:run
        ...
        [bestfit,Bestcost1,Bestcost2,pop,t]=IGKSO20172(fobj,fhd,lb,ub,dim,search_agent,FF);
...
%         biaoji(j1).zong=zongjie;
        ...
        diedaihui_IGKSO2(i1,:)=Bestcost1;
    end
    IGKSO2_huatu(i1).pj=hanshupj;
    IGKSO2_huatu(i1).dd=hanshudd;
...
save('IGKSO2_huatu.mat','diedaihui_IGKSO2')
