...
%% % %              FF=duoyu(i);
    ...
    for j1=1:run
        ...
        [bestfit,Bestcost1,Bestcost2,pop,t]=GKSO(fobj,fhd,lb,ub,dim,search_agent,FF);
...
%         biaoji(j1).zong=zongjie;
        ...
        diedaihui_GKSO(i1,:)=Bestcost1;
    end
    GKSO_huatu(i1).pj=hanshupj;
    GKSO_huatu(i1).dd=hanshudd;
...
save('GKSO_huatu.mat','diedaihui_GKSO')
