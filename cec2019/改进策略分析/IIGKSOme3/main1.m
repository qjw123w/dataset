...
hanshu.pj=[];
hanshu.dd=[];
IIGKSOme_huatu33= repmat(hanshu, 10, 1);
for i =1:10
    F=i;
    for lun=1:runs
...
%         [best_fit,GKSO_curve,X]=cheng14(N,Max_iter,lb,ub,dim,fobj);
        ...
        diedaihui_IIGKSOme33(i,:)=Bestcost1;
    end
    IIGKSOme_huatu33(i).pj=hanshupj;
    IIGKSOme_huatu33(i).dd=hanshudd;
...
save('IIGKSOme_huatu33.mat','diedaihui_IIGKSOme33')