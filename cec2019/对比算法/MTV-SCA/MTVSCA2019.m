...
function [bestfit,Bestcost1,Bestcost2,pop]=MTVSCA2019(fobj,lb,ub,dim,search_agent)
...
%         SCTVP_fit(i) = fobj(SCTVP_pop(i,:));%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        SCTVP_fit(i)=feval(fobj,SCTVP_pop(i,:));
...
%         Pool_TVP_fit(i) = fobj(Pool_TVP(i,:));
         Pool_TVP_fit(i) =feval(fobj,Pool_TVP(i,:));
         FE=FE+1;
...
%         mixVal_trial(i) = fobj(X_trial(i,:));
        mixVal_trial(i) =feval(fobj,X_trial(i,:));
        FE=FE+1;
